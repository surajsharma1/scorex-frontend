      ...
      <main className="flex-1 md:ml-64 p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            ...
            <p className="text-gray-300">Manage your cricket tournaments.</p>
            <button onClick={() => navigate('/tournaments')} className="text-blue-400 hover:underline mt-2">Go to Tournaments</button>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold">Teams</h3>
            <p className="text-gray-300">Organize teams and players.</p>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            ...
            <p className="text-gray-300">Create and view tournament brackets.</p>
            <button onClick={() => navigate('/brackets')} className="text-blue-400 hover:underline mt-2">Go to Brackets</button>
          </div>
        </div>
        <Outlet />
      </main>
