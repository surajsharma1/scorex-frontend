...
import {
  ...
  BarChart3, Radio, Monitor, Target, TrendingUp, Clock
} from 'lucide-react';
    ...
    <div className="min-h-screen p-4 sm:p-6 max-w-5xl relative" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
          ...
          <QuickAction icon={<Monitor className="w-4 h-4" />}   gradient="linear-gradient(135deg,#3b82f6,#2563eb)"  title="Broadcast Overlays" desc="Deploy OBS stream overlays"     onClick={() => navigate('/overlay-manager')} />
