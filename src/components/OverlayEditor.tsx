...
const PRE_DESIGNED_OVERLAYS = [
  ...
  {
    id: 'orbital',
    name: 'Orbital Overlay',
    description: 'Space orbital design with rotating elements',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/orbital-overlay.html',
  },
  {
    id: 'fragment',
    name: 'Fragment Overlay',
    description: 'Modern fragmented design with sharp edges',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/fragment-overlay.html',
  },
  {
    id: 'nebula',
    name: 'Nebula Overlay',
    description: 'Cosmic nebula with purple and blue gradients',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/nebula-overlay.html',
  },
  {
    id: 'aether',
    name: 'Aether Overlay',
    description: 'Ethereal and dreamy aesthetic',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/aether-overlay.html',
  },
  {
    id: 'vector',
    name: 'Vector Overlay',
    description: 'Clean vector-based design',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/vector-overlay.html',
  },
  {
    id: 'vector-shift',
    name: 'Vector Shift',
    description: 'Dynamic vector design with shifting colors',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/vector-shift.html',
  },
  {
    id: 'zenith',
    name: 'Zenith Overlay',
    description: 'Peak design reaching the zenith',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/zenith-overlay.html',
  },
  {
    id: 'chronos',
    name: 'Chronos Overlay',
    description: 'Time-themed overlay with clock elements',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/chronos-overlay.html',
  },
  {
    id: 'obsidian',
    name: 'Obsidian Overlay',
    description: 'Dark obsidian stone aesthetic',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/obsidian-overlay.html',
  },
  {
    id: 'vanguard',
    name: 'Vanguard Overlay',
    description: 'Bold leading edge design',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/vanguard-overlay.html',
  },
  {
    id: 'fractal',
    name: 'Fractal Overlay',
    description: 'Mathematical fractal patterns',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/fractal-overlay.html',
  },
  {
    id: 'glitch',
    name: 'Glitch Overlay',
    description: 'Digital glitch art style',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/glitch-overlay.html',
  },
  {
    id: 'titan-overlay',
    name: 'Titan Overlay',
    description: 'Massive powerful design',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/titan-overlay.html',
  },
  {
    id: 'prism-overlay',
    name: 'Prism Overlay',
    description: 'Light refracting prism effect',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/prism-overlay.html',
  },
  {
    id: 'octane',
    name: 'Octane Overlay',
    description: 'High octane racing style',
    membership: 'premium',
    level: 'designer',
    preview: '/overlays/octane-overlay.html',
  },
];
...
const TEMPLATE_FILE_MAP: Record<string, string> = {
    ...
    // Premium Collection mappings
    'orbital': 'orbital-overlay.html',
    'fragment': 'fragment-overlay.html',
    'nebula': 'nebula-overlay.html',
    'aether': 'aether-overlay.html',
    'vector': 'vector-overlay.html',
    'vector-shift': 'vector-shift.html',
    'zenith': 'zenith-overlay.html',
    'chronos': 'chronos-overlay.html',
    'obsidian': 'obsidian-overlay.html',
    'vanguard': 'vanguard-overlay.html',
    'fractal': 'fractal-overlay.html',
    'glitch': 'glitch-overlay.html',
    'titan-overlay': 'titan-overlay.html',
    'prism-overlay': 'prism-overlay.html',
    'octane': 'octane-overlay.html',
  };
