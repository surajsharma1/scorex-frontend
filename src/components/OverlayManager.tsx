...
import { 
  ...
  Target, ShieldAlert, Timer, Maximize2, Smartphone 
} from 'lucide-react';
    ...
    <div className="space-y-8 mt-4 mx-2">
      ...
      {isMobileFullscreen && activePreview && (
        <div className="fixed inset-0 z-[999] bg-black flex flex-col animate-in fade-in duration-200">
          ...
          {/* Header */}
          <div className="flex justify-between items-center p-4 bg-[#0a0a0f] border-b border-gray-800 shrink-0">
            <div className="text-white font-bold flex items-center gap-3">
              <Smartphone className="w-5 h-5 text-blue-500 animate-pulse" />
              <span className="text-sm">Rotate phone sideways for best view</span>
            </div>
            <button onClick={() => setIsMobileFullscreen(false)} className="p-2 bg-red-500/20 text-red-400 rounded-xl hover:bg-red-500 hover:text-white transition-all">
              <X className="w-6 h-6" />
            </button>
          </div>
