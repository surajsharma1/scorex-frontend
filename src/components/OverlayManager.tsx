...
const generatePreviewUrl = (overlay: any) => {
 ...
 const fireTrigger = (type: string, data: any = {}) => {
 const iframe = document.getElementById('main-preview') as HTMLIFrameElement | null;
 ...
 { label: '🏏 Innings Intro',type: 'START_INNINGS_INTRO',color: '#06b6d4' },
 ...
 { label: '🏏 Bat Card', type: 'BATTING_CARD', color: '#60a5fa' },
 { label: '🎳 Bowl Card', type: 'BOWLING_CARD', color: '#818cf8' },
 ...
 { label: '🏆 Match End', type: 'MATCH_END', color: '#fb923c' },
