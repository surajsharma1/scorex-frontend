    ...
    <div className="p-6 max-w-5xl relative min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="flex items-center justify-between mb-8 relative">
        ...
        <Link to="/tournaments/create"
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all hover:scale-105 shadow-lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tournaments.map(t => (
            <div key={t._id} onClick={() => navigate(`/tournaments/${t._id}`)}
              ...
              <h3 className="text-lg font-black mb-2 line-clamp-1 group-hover:text-green-400 transition-colors" style={{ color: 'var(--text-primary)' }}>
                {t.name}
              </h3>
